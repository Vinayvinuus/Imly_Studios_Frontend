              ...
              <Box
                sx={{
                  ...
                  '@media (max-width: 1300px)': {
                    gridTemplateColumns: "1fr 1fr", // Keep 2 columns layout for 1300px and below
                  },
                  '@media (max-width: 700px)': {
                    gridTemplateColumns: "1fr", // Stack fields vertically for smaller screens
              ...
              >
                ...
                {activeStep === 0 && (
                  <>
                    <div className="grid ">
                      <div className="flex justify-left items-center h-full">
                        <div className="relative flex flex-col w-[25rem] pb-2">
                          <input
                            id="searchName"
                            type="text"
                            placeholder="Search by Name..."
